...
import { Save, Settings, Clock, Target, Check } from 'lucide-react';

// Horários e meta de cada turno — separado da tela de Parâmetros de OEE de
// propósito (ver OeeConfigView.jsx): são duas configurações independentes,
// uma diz QUANDO cada turno acontece e a meta dele, a outra diz QUAIS
// variáveis alimentam o cálculo do OEE.
        ...
        <div className="flex items-center gap-4">
          <div>
            <h1 className="text-xl font-bold text-amber-500 flex items-center gap-2">
              <Settings size={22} /> Configuração de Turnos (PostgreSQL)
            </h1>
